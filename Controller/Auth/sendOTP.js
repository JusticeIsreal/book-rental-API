...
const sendOTPVerificationEmail = async ({ _id, email }, res) => {
  try {
    ...
    const mailOptions = {
      ...
      html: `<p> Enter <b>${otp}</b> into the application to verify your email and complete your registration</p><p style={{color:"red"}}> <b>This OTP will expire in 1 hour</b></p>`,
    };
